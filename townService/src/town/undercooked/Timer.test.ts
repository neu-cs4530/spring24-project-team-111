...
describe('Timer', () => {
  ...
  it('timer after 10 second', () => {
    ...
    setTimeout(() => {
      timer2.stopTimer();
      expect(timer2.currentTime).toBe(10);
    }, 10000);
  });
  ...
  it('timer after 19 second', () => {
    ...
    setTimeout(() => {
      timer3.stopTimer();
      expect(timer3.currentTime).toBe(1);
    }, 19000);
  });
  ...
  it('timer after 20 second', () => {
    ...
    setTimeout(() => {
      timer4.stopTimer();
      expect(timer4.currentTime).toBe(0);
    }, 20000);
  });
  ...
  it('timer after 21 second', () => {
    ...
    setTimeout(() => {
      timer5.stopTimer();
      expect(timer5.currentTime).toBe(0); // After 1 second
    }, 21000);
  });
  ...
  it('timer after 30 second', () => {
    ...
    setTimeout(() => {
      timer6.stopTimer();
      expect(timer6.currentTime).toBe(0); // After 1 second
    }, 30000);
  });
});
